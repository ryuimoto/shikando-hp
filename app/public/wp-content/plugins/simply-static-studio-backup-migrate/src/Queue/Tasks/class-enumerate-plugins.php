...
use Simply_Static\Backup\ThirdParty\servmask\backup\Backup_Enumerate_Plugins;

class Enumerate_Plugins extends Backup_Task {

	public function run() {
		$params = $this->get_task_params();

		$init = new Backup_Enumerate_Plugins();
