 ...
 * Categories: shikando
 * Description: 電話占い・チャット占いのサービス概要セクション
 *
 * @package Shikando
 */
?>
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" style="letter-spacing:0.15em">占いメニュー</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group is-style-washi-card">
				<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"letterSpacing":"0.1em"}},"fontSize":"large","textColor":"accent-2"} -->
				<h3 class="wp-block-heading has-text-align-center has-accent-2-color has-text-color has-large-font-size" style="letter-spacing:0.1em">チャット占い</h3>
				<!-- /wp:heading -->
				<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
